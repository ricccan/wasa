...
func (rt *_router) getName(w http.ResponseWriter, r *http.Request, ps httprouter.Params) { // dichiarazioe funzione base
	...
	result, err := rt.db.GetName(id) // chiamo la funzione
